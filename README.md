...
This repository also provides list of custom instructions, skills, and agents that are used for development of different products of Data Mesh. For details, see [development resources](./development/resources/README.md)   